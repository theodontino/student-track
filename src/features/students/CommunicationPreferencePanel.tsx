...
const labels: Record<string, string> = { unknown: "未知", short: "简短", standard: "标准", detailed: "详细", teacher_conclusion: "教师结论", classroom_example: "课堂例子", data_trend: "数据趋势", plain: "生活化", basic: "基础术语", professional: "专业细节", inform_only: "只知情", remind_confirm: "提醒/确认", observe_report: "观察/反馈", simple_check: "简单检查", every_session: "每次课", stage_only: "阶段性", exception_only: "异常时" };
...
export default function CommunicationPreferencePanel({ studentId }: { studentId: string }) {
  ...
  const [draft, setDraft] = useState<Record<string, Value>>({ length: "unknown", evidence: "unknown", terminology: "unknown", familyParticipation: "unknown", frequency: "unknown" });
