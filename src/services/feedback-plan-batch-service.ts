...
async function retiredBatchGeneration(...args: unknown[]): Promise<never> {
  void args;
  throw new ApiError("历史批次只读，请复制为学生计划后生成", 409, "legacy_generation_retired", false);
}
export const startFeedbackPlanBatch = retiredBatchGeneration;
export const pauseFeedbackPlanBatch = retiredBatchGeneration;
export const continueFeedbackPlanBatch = retiredBatchGeneration;
export const forceStopFeedbackPlanBatch = retiredBatchGeneration;
export const retryFeedbackPlanBatch = retiredBatchGeneration;
export const retryFeedbackPlanBatchWithFree = retiredBatchGeneration;
