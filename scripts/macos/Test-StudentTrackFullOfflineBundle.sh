...
export STUDENT_TRACK_DATA_ROOT="$STUDENT_TRACK_RUNTIME_ROOT/data"
export STUDENT_TRACK_ARCHIVES_ROOT="$STUDENT_TRACK_RUNTIME_ROOT/archives"
export STUDENT_TRACK_FEEDBACK_ATTACHMENTS_ROOT="$STUDENT_TRACK_RUNTIME_ROOT/feedback-attachments"
export STUDENT_TRACK_FEEDBACK_INBOX_ROOT="$STUDENT_TRACK_RUNTIME_ROOT/feedback-inbox"
