...
1.2 beta.5 的公共材料迁移只为 `ClassSession` 增加可空的 `commonMaterialSnapshot` 与 `commonMaterialConfirmedAt`。既有课次为空即表示没有独立快照；已关联共同课的反馈仍以共同课修订为准，不回填或改写历史课堂事实和反馈计划。
