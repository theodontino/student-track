...
| 组件 | 版本 | 联合验证范围 |
|---|---:|---|
| Student Track | 1.1.0-beta.5 | 学期班级与名单归属、名单预览导入、家长反馈偏好候选教师复核、问答上下文归类、incoming 证据门禁、出门测进入反馈计划且全部已确认教学/测评证据强制进入可查看初稿、LLM 空结果的证据化安全兜底、`no_value`/未确认草稿重新分拣与可追溯生成版本。 |
