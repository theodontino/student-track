...
| 组件 | 版本 | 与另一端的关系 |
|---|---:|---|
| Student Track | 1.3.0-beta.1 | 计划成为反馈业务主体；新增班级/学期 30 天回收站、课次事实清空、统一状态与跨班反馈队列，按 Zhuiver 归为 MINOR 预发布。 |
...
| 组件 | 版本 | 联合验证范围 |
|---|---:|---|
| Student Track | 1.3.0-beta.1 | 回收站、事实清空、计划另存和统一反馈队列不改变 GroupLesson 确认修订、handoff v1、教师批准和 no-send 边界。 |
