...
| 组件 | 版本 | 与另一端的关系 |
|---|---:|---|
| Student Track | 1.2.6 | 补齐完整课程周期与教师纯页面验收；修复计划恢复、任务状态文案和学生导航布局，按 Zhuiver 归为 PATCH。 |
...
| 组件 | 版本 | 联合验证范围 |
|---|---:|---|
| Student Track | 1.2.6 | 单班和班级组继续复用 FeedbackPlan/Batch；新增验收覆盖与工作室 UX 修复，不改变 handoff v1、FeedbackPlan 历史、教师批准和 no-send 边界。 |
