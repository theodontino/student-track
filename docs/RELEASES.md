...
| 组件 | 版本 | 与另一端的关系 |
|---|---:|---|
| Student Track | 1.2.10 | 命名反馈计划支持草稿保存、全过程回看和以新计划安全修订；生成后的原计划及结果保持不变，按 Zhuiver 归为 PATCH。 |
...
| 组件 | 版本 | 联合验证范围 |
|---|---:|---|
| Student Track | 1.2.10 | 计划命名、草稿保存、回看和来源修订不改变 GroupLesson 确认修订、handoff v1、教师批准和 no-send 边界。 |
