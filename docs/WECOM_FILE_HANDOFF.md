...
本协议当前稳定配对由 WCG（WeComCatch GUI）v0.6.0 与 Student Track v1.1.4 共同维护；Student Track 1.1.1 起与 WCG 0.5 beta 在完全保留 v1 字段、目录结构和原子写顺序的前提下增加不可变修订、反馈证据覆盖与不发送草稿填入。WCG
